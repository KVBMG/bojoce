...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('candidat_cv', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\InjectListener('user_image', $e, $a, $b));
        ...
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\InjectListener('candidat_cv', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('candidat_cv', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('candidat_cv', $e, $a, $b));
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'eco_job_fr', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $d, $f, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_c5d77488936330fff662a4d3a2c1e7e47c29ea6bb714d556ef91809cf282341f');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/winzou/console-bundle/CoreSphere/ConsoleBundle/Resources/views'), 'CoreSphereConsole');
        ...
        return array(
            ...
            'kernel.bundles_metadata' => array(
                ...
                'CoreSphereConsoleBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/vendor/winzou/console-bundle/CoreSphere/ConsoleBundle'),
