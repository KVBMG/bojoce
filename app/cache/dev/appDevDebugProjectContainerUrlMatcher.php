...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/recruteur')) {
            ...
            if (0 === strpos($pathinfo, '/recruteur/banquecv')) {
                ...
                if ($pathinfo === '/recruteur/banquecv/search') {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        goto not_eco_job_recruteur_banquecv_search;
                    }

                    return array (  '_controller' => 'EcoJob\\RecruteurBundle\\Controller\\RecruteurController::searchAjaxAction',  '_route' => 'eco_job_recruteur_banquecv_search',);
                }
                not_eco_job_recruteur_banquecv_search:

                // eco_job_recruteur_banquecv_show
                if (0 === strpos($pathinfo, '/recruteur/banquecv/cv/show') && preg_match('#^/recruteur/banquecv/cv/show/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        goto not_eco_job_recruteur_banquecv_show;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'eco_job_recruteur_banquecv_show')), array (  '_controller' => 'EcoJob\\RecruteurBundle\\Controller\\RecruteurController::showCVAction',));
                }
                not_eco_job_recruteur_banquecv_show:
        ...
        if (0 === strpos($pathinfo, '/candidat')) {
            ...
            if (0 === strpos($pathinfo, '/candidat/offre')) {
                ...
                if (preg_match('#^/candidat/offre/(?P<id>[^/]++)/saveAsync$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        goto not_eco_job_candidat_offre_save_async;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'eco_job_candidat_offre_save_async')), array (  '_controller' => 'EcoJob\\CandidatBundle\\Controller\\CandidatController::saveAsyncAction',));
                }
                not_eco_job_candidat_offre_save_async:
            ...
            if (0 === strpos($pathinfo, '/candidat/c')) {
                ...
                if (0 === strpos($pathinfo, '/candidat/cv/gestion')) {
                    // eco_job_candidat_gerercv
                    if ($pathinfo === '/candidat/cv/gestion') {
                        if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'HEAD'));
                            goto not_eco_job_candidat_gerercv;
                        }

                        return array (  '_controller' => 'EcoJob\\CandidatBundle\\Controller\\CandidatController::gererCVAction',  '_route' => 'eco_job_candidat_gerercv',);
                    }
                    not_eco_job_candidat_gerercv:

                    // eco_job_candidat_gerercv_stop
                    if (preg_match('#^/candidat/cv/gestion/(?P<id>[^/]++)/stop$#s', $pathinfo, $matches)) {
                        if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'HEAD'));
                            goto not_eco_job_candidat_gerercv_stop;
                        }

                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'eco_job_candidat_gerercv_stop')), array (  '_controller' => 'EcoJob\\CandidatBundle\\Controller\\CandidatController::stopAction',));
                    }
                    not_eco_job_candidat_gerercv_stop:
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if (0 === strpos($pathinfo, '/admin/users')) {
                ...
                if (0 === strpos($pathinfo, '/admin/users/new')) {
                    ...
                    if ($pathinfo === '/admin/users/new/candidat') {
                        if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'HEAD'));
                            goto not_eco_job_admin_users_new_candidat;
                        }

                        return array (  '_controller' => 'EcoJob\\AdminBundle\\Controller\\AdminController::getNewCandidatAction',  '_route' => 'eco_job_admin_users_new_candidat',);
                    }
                    not_eco_job_admin_users_new_candidat:

                    // eco_job_admin_users_new_recruteur
                    if ($pathinfo === '/admin/users/new/recruteur') {
                        if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'HEAD'));
                            goto not_eco_job_admin_users_new_recruteur;
                        }

                        return array (  '_controller' => 'EcoJob\\AdminBundle\\Controller\\AdminController::getNewRecruteurAction',  '_route' => 'eco_job_admin_users_new_recruteur',);
                    }
                    not_eco_job_admin_users_new_recruteur:
            ...
            if (0 === strpos($pathinfo, '/admin/offres/list')) {
                ...
                if ($pathinfo === '/admin/offres/list/suspendu') {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                        goto not_eco_job_admin_offres_suspendu;
                    }

                    return array (  '_controller' => 'EcoJob\\AdminBundle\\Controller\\AdminController::getOffreSuspenduAction',  '_route' => 'eco_job_admin_offres_suspendu',);
                }
                not_eco_job_admin_offres_suspendu:
