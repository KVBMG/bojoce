 ...
 */
class ContratCategorie extends \EcoJob\RecruteurBundle\Entity\ContratCategorie implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'EcoJob\\RecruteurBundle\\Entity\\ContratCategorie' . "\0" . 'id', '' . "\0" . 'EcoJob\\RecruteurBundle\\Entity\\ContratCategorie' . "\0" . 'designation', '' . "\0" . 'EcoJob\\RecruteurBundle\\Entity\\ContratCategorie' . "\0" . 'offres'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ContratCategorie $proxy) {
