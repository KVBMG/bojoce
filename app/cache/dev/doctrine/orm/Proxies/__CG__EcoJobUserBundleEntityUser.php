...
namespace Proxies\__CG__\EcoJob\UserBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \EcoJob\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'username', '' . "\0" . 'EcoJob\\UserBundle\\Entity\\User' . "\0" . 'type', '' . "\0" . 'EcoJob\\UserBundle\\Entity\\User' . "\0" . 'curriculum', '' . "\0" . 'EcoJob\\UserBundle\\Entity\\User' . "\0" . 'cvFile', '' . "\0" . 'EcoJob\\UserBundle\\Entity\\User' . "\0" . 'offres', '' . "\0" . 'EcoJob\\UserBundle\\Entity\\User' . "\0" . 'candidatures', '' . "\0" . 'EcoJob\\UserBundle\\Entity\\User' . "\0" . 'cdtures_rec', '' . "\0" . 'EcoJob\\UserBundle\\Entity\\User' . "\0" . 'postuled', 'captchaCode', '' . "\0" . 'EcoJob\\UserBundle\\Entity\\User' . "\0" . 'createdAt', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
    ...
    public function addPostuled(\EcoJob\RecruteurBundle\Entity\Offre $postuled)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addPostuled', [$postuled]);

        return parent::addPostuled($postuled);
    }
    ...
    public function removePostuled(\EcoJob\RecruteurBundle\Entity\Offre $postuled)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removePostuled', [$postuled]);

        return parent::removePostuled($postuled);
    }
    ...
    public function getPostuled()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPostuled', []);

        return parent::getPostuled();
    }
    ...
    public function addCdturesRec(\EcoJob\CandidatBundle\Entity\Candidature $cdturesRec)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addCdturesRec', [$cdturesRec]);

        return parent::addCdturesRec($cdturesRec);
    }
    ...
    public function removeCdturesRec(\EcoJob\CandidatBundle\Entity\Candidature $cdturesRec)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeCdturesRec', [$cdturesRec]);

        return parent::removeCdturesRec($cdturesRec);
    }
    ...
    public function getCdturesRec()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCdturesRec', []);

        return parent::getCdturesRec();
    }
