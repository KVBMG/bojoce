 ...
 */
class ContratType extends \EcoJob\RecruteurBundle\Entity\ContratType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'EcoJob\\RecruteurBundle\\Entity\\ContratType' . "\0" . 'id', '' . "\0" . 'EcoJob\\RecruteurBundle\\Entity\\ContratType' . "\0" . 'libelle', '' . "\0" . 'EcoJob\\RecruteurBundle\\Entity\\ContratType' . "\0" . 'offres'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ContratType $proxy) {
