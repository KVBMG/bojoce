...
class Offre extends \EcoJob\RecruteurBundle\Entity\Offre implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'EcoJob\\RecruteurBundle\\Entity\\Offre' . "\0" . 'id', '' . "\0" . 'EcoJob\\RecruteurBundle\\Entity\\Offre' . "\0" . 'experience', '' . "\0" . 'EcoJob\\RecruteurBundle\\Entity\\Offre' . "\0" . 'titre', '' . "\0" . 'EcoJob\\RecruteurBundle\\Entity\\Offre' . "\0" . 'contenu', '' . "\0" . 'EcoJob\\RecruteurBundle\\Entity\\Offre' . "\0" . 'contrat', '' . "\0" . 'EcoJob\\RecruteurBundle\\Entity\\Offre' . "\0" . 'recruteur', '' . "\0" . 'EcoJob\\RecruteurBundle\\Entity\\Offre' . "\0" . 'valid', '' . "\0" . 'EcoJob\\RecruteurBundle\\Entity\\Offre' . "\0" . 'suspendu', '' . "\0" . 'EcoJob\\RecruteurBundle\\Entity\\Offre' . "\0" . 'modificationValided', '' . "\0" . 'EcoJob\\RecruteurBundle\\Entity\\Offre' . "\0" . 'added', '' . "\0" . 'EcoJob\\RecruteurBundle\\Entity\\Offre' . "\0" . 'expired', '' . "\0" . 'EcoJob\\RecruteurBundle\\Entity\\Offre' . "\0" . 'latitude', '' . "\0" . 'EcoJob\\RecruteurBundle\\Entity\\Offre' . "\0" . 'longitude', '' . "\0" . 'EcoJob\\RecruteurBundle\\Entity\\Offre' . "\0" . 'localisation', '' . "\0" . 'EcoJob\\RecruteurBundle\\Entity\\Offre' . "\0" . 'candidatures', '' . "\0" . 'EcoJob\\RecruteurBundle\\Entity\\Offre' . "\0" . 'createdAt', '' . "\0" . 'EcoJob\\RecruteurBundle\\Entity\\Offre' . "\0" . 'expireAt', '' . "\0" . 'EcoJob\\RecruteurBundle\\Entity\\Offre' . "\0" . 'categorie', '' . "\0" . 'EcoJob\\RecruteurBundle\\Entity\\Offre' . "\0" . 'validAt'];
        }
    ...
    public function setModificationValided($modificationValided)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setModificationValided', [$modificationValided]);

        return parent::setModificationValided($modificationValided);
    }
    ...
    public function getModificationValided()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getModificationValided', []);

        return parent::getModificationValided();
    }
