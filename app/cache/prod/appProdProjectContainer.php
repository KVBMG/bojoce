...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => '@FOSUser/Registration/email.txt.twig', 'resetting.template' => '@FOSUser/Resetting/email.txt.twig', 'from_email' => array('confirmation' => array('postmaster@eco-job.fr' => 'eco-job.fr'), 'resetting' => array('postmaster@eco-job.fr' => 'eco-job.fr'))));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'postmaster@eco-job.fr' => 'eco-job.fr',
            ),
